  ...
  const features = [
    {
      ...
      included: !!(isPremium && user?.subscription_features?.custom_reminders),
      emoji: "⏰",
    },
    {
      icon: ActivitySquare,
      ...
      included: !!(isPremium && user?.subscription_features?.risk_predictions),
      emoji: "📉",
    },
    {
      icon: FileDown,
      ...
      included: !!(isPremium && user?.subscription_features?.data_export),
      emoji: "📄",
    },
    {
      icon: BarChartBig,
      ...
      included: !!(isPremium && user?.subscription_features?.advanced_analytics),
      emoji: "📊",
    },
  ];
