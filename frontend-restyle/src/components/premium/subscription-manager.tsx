...
import { ArrowRight, Calendar, CheckCircle, Clock, CreditCard, Crown, Gift, Heart, Shield, Sparkles, Star, Users, Wallet, Zap } from "lucide-react"
...
const currentCurrency: "ARS" = "ARS"

const FeatureCard: React.FC<FeatureCardProps> = ({ icon: Icon, title, description, included, emoji }) => (
  <div
    className={`group relative overflow-hidden rounded-xl shadow-md border transition-all duration-300 transform hover:-translate-y-1 ${included
    ...
    <div className="p-4">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          <div
            className={`p-2 rounded-lg shadow-sm ${included
        ...
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl p-4 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-bold mb-1">Subscribe to premium 👑</h2>
                <p className="text-purple-100 text-sm">Get access to advanced features to better manage your medications</p>
              </div>
            </div>
    ...
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-br from-white to-green-50 rounded-xl p-4 shadow-md border border-green-100">
        <div className="flex items-center space-x-2 mb-3">
          ...
          <h3 className="font-bold text-sm text-gray-800">Upgrade to Premium</h3>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4">
          <button
            onClick={() => setSelectedPaymentMethod("stripe")}
            disabled={createCheckoutSession.isPending}
            className={`flex items-center justify-center px-3 py-2 rounded-lg border transition-all duration-200 ${selectedPaymentMethod === "stripe"
          ...
          <button
            ...
            disabled={createCheckoutSession.isPending}
            className={`flex items-center justify-center px-3 py-2 rounded-lg border transition-all duration-200 ${selectedPaymentMethod === "mercadopago"
