...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-11 items-center justify-center rounded-lg px-1 bg-muted text-muted-foreground gap-1',
      className
    )}
    {...props}
  />
